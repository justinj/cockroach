...
func NewServer(cfg Config, stopper *stop.Stopper) (*Server, error) {
	...
	// We set the noteworthy size to the maximum because the children of this
	// monitor will be setting their own noteworthy limits.
	rootSQLMemoryMonitor := mon.MakeMonitor("root", nil, nil, 0, math.MaxInt64 /* noteworthy */)
